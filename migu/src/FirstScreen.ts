class FirstScreen extends Base{
	...
	private c_r:number = 0;

	private resArr = [77,77,77,77,77];
	/*第一个问答*/
	private f_page :egret.Sprite;
	/*第二个问答*/
	private s_page :egret.Sprite;
	/*第三个问答*/
	private t_page :egret.Sprite;
	/*第四个问答*/
	private ft_page:egret.Sprite;
	/*第五个问答*/
	private ff_page:egret.Sprite;
	...
	private addTimeLine(timeline:egret.Bitmap,indicater:egret.Bitmap,_index:number){
	...
	private handleRes(_text:string){
		var self = this;
	...
	private createText(_str,_w,_h,_x,_y,_size:number=22){
